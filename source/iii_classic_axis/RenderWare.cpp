...
RwCamera* DoRWStuffStartOfFrame(char a1, char a2, char a3, char a4, char a5, char a6, __int16 a7) {
	return ((RwCamera*(__cdecl *)(char, char, char, char, char, char, __int16))0x48CF10)(a1, a2, a3, a4, a5, a6, a7);
}

RwCamera* RsCameraShowRaster(RwCamera* camera) {
	return ((RwCamera*(__cdecl *)(RwCamera*))0x5848A0)(camera);
}
...
RsEventStatus RsEventHandler(RsEvent eventID, void* param) {
	return ((RsEventStatus(__cdecl *)(RsEvent, void*))0x584A20)(eventID, param);
}